...
// cl -std:c++17 -nologo -Os "$Name.cc" -c
// link -nologo "-OPT:REF" "-OPT:ICF" -NODEFAULTLIB -SUBSYSTEM:CONSOLE
// -ENTRY:wmain "$Name.obj" "$Name.res" kernel32.lib user32.lib "-OUT:$Name.exe"
#define WIN32_LEAN_AND_MEAN
#include <windows.h>
#include <winnt.h>

// Will replace LINK_TEMPLATE_TARGET
